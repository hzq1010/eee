...
if __name__ == '__main__':
    ...
    #
    # mk = 0x0123456789abcdeffedcba9876543210
    # # mk = 0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef,0xfe,0xdc,0xba,0x98,0x76,0x54,0x32,0x10
    #
    #
    # # 密文
    # cipher_num = 0x681edf34d206965e86b3e94f536e4246
    #
    # # 明文
    # clear_num1 = 0x0123456789abcdeffedcba98765432100123456789abcdeffedcba98765432100123456789abcdeffedcba9876543210
    # #密文
    # cipher_num1 =0x1082cbc294f79c4da59e4fddc5be0538dd53e1aa2683ef3fa5e238110e35f96f
    # #密鑰
    # mk1 = 0x7a68676c000000000000000000000000
    # # print(hex(encrypt(clear_num,mk)))
    # # print(hex(decrypt(cipher_num,mk)))
    ...
    print((decrypt(cipher_num, mk)).decode())

    # print(encrypt(cipher_num1, mk1))
